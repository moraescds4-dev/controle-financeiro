"use client";import { formatarMoeda } from "@/lib/formato";
    ...
    <div className="h-80 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={dados} margin={{ top: 10, right: 10, left: 0, bottom: 10 }}>
          ...
          <YAxis width={100} tick={{ fill: "currentColor", fontSize: 12 }} tickFormatter={(v) => formatarMoeda(Number(v))} />
          {mostrarTooltip && <Tooltip formatter={(v) => formatarMoeda(Number(v))} contentStyle={{ borderRadius: 8 }} />}
